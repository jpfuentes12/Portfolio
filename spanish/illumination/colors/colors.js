...
var fourcolors = document.getElementById("fourcolors");
...
fourcolors.onclick = function(){
    video.style.opacity = "0";
    borders();
    viewer.style.backgroundImage= "url('fourcolors.jpg')";
    fourcolors.style.border = "solid gray";
}
